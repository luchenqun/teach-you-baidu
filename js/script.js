...
$(function () {
          ...
          typeInterval = setInterval(function () {
            ...
            if (++i > query.length) {
              ...
              $arrow.removeClass('active').fadeIn().animate({
                ...
                $tips.html('<strong style="color: red; font-size: 32px;">怎么样，学会了吗？</strong>');
                $arrow.addClass('active');
  ...
  $('#search-form').submit(function () {
    ...
    if (!question) {
      ...
      let baidu = window.location.origin + window.location.pathname + '?q=' + Base64.encode(question);
      let url = "https://v1.alapi.cn/api/url/?type=148&url=" + baidu;
      $.ajax({
        url: url,
        type: "GET",
        cache: false,
